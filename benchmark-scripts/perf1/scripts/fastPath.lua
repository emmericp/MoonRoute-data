...
--  fastPath iteration
function mod.run(initLpmTable, distributor, rxQueues, slowQueue, cmdRxQueue, cmdTxQueue, maxBurstSize, coreId, testTxQueues)
  ...
  --     if (nrx > 0) then
  --       totRx = totRx + nrx
  --       testTxQueues[math.random(#testTxQueues)]:sendN(bufs, nrx)
  --     end
  --   end
  -- end
