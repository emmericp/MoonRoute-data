--- EDIT TX FUNCTION BELOW TO ADJUST USED DST IPS
...
function loadSlave(queue, rxDev, size, flows)
	...
	while mg.running() do
		...
		for i, buf in ipairs(bufs) do
			...
			-- ADJUST HERE FOR ROUTING TABLE ENTRIES
			pkt.ip4.dst:set(math.random(0, 255) * 256 + math.random(0, 255) * 256 ^ 2 + math.random(1, 16) * 256^3)
		end
